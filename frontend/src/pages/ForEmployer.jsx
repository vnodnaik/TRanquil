...
import { Building2, Users, Clock, Award, CheckCircle2, TrendingUp } from 'lucide-react';
...
const ForEmployer = () => {
  ...
  return (
    <div className="for-employer-page" data-testid="for-employer-page">
      ...
      {/* Process Section */}
      <section className="section-padding bg-gray-50" data-testid="employer-process-section">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12" data-testid="process-title">
            Our Hiring Process
          </h2>
          <div className="max-w-4xl mx-auto">
            <div className="space-y-8">
              <div className="flex gap-6" data-testid="process-step-1">
              ...
              <div className="flex gap-6" data-testid="process-step-2">
                <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center text-white font-bold" style={{ backgroundColor: '#FF6B35' }}>
                  2
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Sourcing & Screening</h3>
                  <p className="text-gray-600">
                    Our recruiters tap into extensive networks and databases to find qualified candidates, conducting thorough screenings.
                  </p>
                </div>
              </div>
              <div className="flex gap-6" data-testid="process-step-3">
                <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center text-white font-bold" style={{ backgroundColor: '#FF6B35' }}>
                  3
                </div>
                <div>
                  ...
                  <p className="text-gray-600">
                    We present shortlisted candidates with detailed profiles, including assessments and reference checks.
                  </p>
                </div>
              </div>
              <div className="flex gap-6" data-testid="process-step-4">
                <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center text-white font-bold" style={{ backgroundColor: '#FF6B35' }}>
                  4
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Interview Coordination</h3>
                  <p className="text-gray-600">
                    We facilitate the interview process, coordinating schedules and gathering feedback from all parties.
                  </p>
                </div>
              </div>
              <div className="flex gap-6" data-testid="process-step-5">
                <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center text-white font-bold" style={{ backgroundColor: '#FF6B35' }}>
                  5
                </div>
                <div>
                  ...
                  <p className="text-gray-600">
                    We assist with offer negotiations and support the onboarding process to ensure a smooth transition.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* Post Job Section */}
      <section className="section-padding" data-testid="post-job-section">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4" data-testid="post-job-title">
              Post a Job
            </h2>
            <p className="text-center text-gray-600 mb-8">
              Fill out the form below to post your job opening
            </p>
            <form onSubmit={handleSubmit} className="card p-8" data-testid="post-job-form">
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2" htmlFor="salary_range">
                      Salary Range
                    </label>
                    <input
                      type="text"
      ...
      {/* CTA Section */}
      <section className="section-padding bg-gray-50 text-center" data-testid="employer-cta">
        <div className="container mx-auto px-4">
          ...
          <a href="/contact" data-testid="employer-cta-contact">
